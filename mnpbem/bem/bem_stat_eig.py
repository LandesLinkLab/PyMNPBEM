...
#
# BEMStatEig's quasistatic eigenmode pipeline is dominated
...
def _plasmonmode_gpu(p, F, nev, options):
    ...
    # plasmonmode.  This matches behaviour exactly so a user who
...
class BEMStatEig(object):
    ...
    def __init__(self,
        ...
        **options : dict
        ...
        F = self.g.F  # (n, n)
        # F may live on cupy when MNPBEM_GPU=1.  Bring it to
        ...
        # plasmonmode internally builds (and discards) a dense
    ...
    def _init_matrices(self, enei):
        ...
        # drop the previous wavelength's resolvent ``mat``
        ...
        # drop the inv_ul intermediate (~ nev × N) so cupy
    ...
    def clear(self):
        ...
        Added for API parity with BEMStat / BEMStatLayer /
        ...
        self.mat = None
        self.enei = None
        # explicit clear() drains the cupy pool so the device

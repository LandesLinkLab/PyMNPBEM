...
# mirror BEMStat / BEMStatIter's wavelength-end cupy pool
...
class BEMStatLayer(object):
    ...
    def __init__(self,
        ...
        # F may live on cupy when the upstream Green-function
    ...
    def _init_matrices(self,
        ...
        # Distributed multi-GPU build path. When the dedicated env
        ...
        # free previous wavelength's LU before allocating
        # new buffers.  Mirrors the BEMStat / BEMStatIter pattern.
        self._A_lu = None
        self._rhs_scale = None
        ...
        # H1/H2 from the layer Green function may be cupy
        ...
        # H1/H2 are no longer needed after A is formed.
    ...
    def _init_distributed_assemble(self,
            enei: float) -> 'BEMStatLayer':
        """Distributed multi-GPU build for the quasistatic substrate solver.
    ...
    def __truediv__(self,
        ...
        # post-solve pool drain mirrors BEMStat.__truediv__.
        if _CUPY_OK_LAYER:
            _gpu_pool_cleanup_layer()
    ...
    def clear(self) -> 'BEMStatLayer':
        ...
        # Drop the real LU factor / rhs scale held in
        ...
        # Close mgpu LU handle and release its distributed buffers
        ...
        self._rhs_scale = None
        self.enei = None
        # explicit clear() signals the user wants the

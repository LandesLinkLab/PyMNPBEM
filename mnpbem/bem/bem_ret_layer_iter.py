...
class BEMRetLayerIter(BEMIter):
    ...
    def __init__(self,
        ...
        # form that has no ACA wrapper, so it cannot be combined with the
        # dense-LU Schur in _init_precond. Surface an explicit error so
        # users with layered geometries fall back to the dense path
        # consciously.
        if options.pop('hmatrix', False):
            raise NotImplementedError(
                '[error] BEMRetLayerIter does not support <hmatrix>; '
    ...
    def _init_matrices(self,
        ...
        # wavelength-entry GPU cleanup.  Drop the previous wavelength's
        ...
        # distributed inner-pair assembly hook.
        ...
        if not distributed_inner_built:
            ...
            # Coerce every eval() output to host numpy when GPU
            ...
            # G11/G21 have already been coerced to host; the cupy buffers
        ...
        # drop the intermediate Green-function locals so the cupy
        ...
        if self.precond is not None:
            ...
            # the preconditioner builds 4 dense LUs (~4 N^2 each on
    ...
    def _build_distributed_GH_inner(self,
        ...
        """build inner-pair G1/H1 with distributed assembly.
    ...
    def _init_precond(self,
        ...
        # Waxenegger et al., Comp. Phys. Commun. 193, 128 (2015)
        #
        # multi-material + substrate fix.  Mirrors the
        # BEMRetIter operator-form correction but for the layered
        ...
        # forward MNPBEM_VRAM_SHARE_* env vars
        ...
        sav['G2'] = G2
        sav['Sigma1'] = Sigma1
        sav['Sigma1e'] = Sigma1e        # H1·eps1·G1⁻¹
    ...
    def _afun(self,
        ...
        #
        # multi-material + substrate fix.  Mirrors the
        # BEMRetIter operator-form correction.  The dense
        ...
        # mechanism that drove the 70 % drift on BEMRetIter.
        #
    ...
    def _mfun(self,
        ...
        # Waxenegger et al., Comp. Phys. Commun. 193, 138 (2015)
        #
        # operator-form alpha/De modifications.  The
    ...
    def solve(self,
        ...
        # drop the GMRES matvec closures (which keep references to

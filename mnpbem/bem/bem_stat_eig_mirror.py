...
class BEMStatEigMirror(object):
    ...
    def __init__(self,
        ...
        for i in range(len(F_list)):
            ...
            # with MNPBEM_GPU_EIG=1 AND a working cupy.linalg.eig
            ...
            # falls back to the scipy.sparse.linalg.eigs path
            ...
            # per-symmetry pool drain — each eigs block can
    ...
    def _init_matrices(self, enei: float) -> 'BEMStatEigMirror':
        ...
        # drop the previous wavelength's resolvent matrices
        ...
        for i in range(len(self.ur)):
            ...
            # drop per-block scratch so the next symmetry
    ...
    def clear(self) -> 'BEMStatEigMirror':
        ...
        API parity with BEMStat / BEMStatLayer / BEMStatMirror

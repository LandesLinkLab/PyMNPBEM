...
class Particle(object):
    ...
    def _norm_curv(self):
        ...
        per-face Python loop replaced by tensor contractions for
    ...
    def _quad_flat(self, ind=None):
        ...
        # vectorise per-triangle Python loop into tensor contractions.
    ...
    def _quadpol_flat(self, ind=None):
        ...
        per-face Python loop replaced by tensor contractions.
    ...
    def _quadpol_curv(self, ind=None):
        ...
        per-face Python loops replaced by tensor contractions
    ...
    def _quad_curv(self, ind=None):
        ...
        per-triangle Python loop replaced by tensor contractions —

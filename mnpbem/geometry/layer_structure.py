...
class LayerStructure(object):
    ...
    def __init__(self,
        ...
        # Sommerfeld integration backend selection.
        ...
        # high-accuracy GL panels backend. Demos requiring
        ...
        # Bit-exact MATLAB ode45 step controller. When set, the ODE
        ...
        # Sommerfeld GL panel/order configuration.
        # Defaults are suitable for most demos.
        ...
        # Opt-in MATLAB Engine API path for Green function
    ...
    def _init_matlab_engine(self, epstab: list) -> None:
        # Spin up MATLAB Engine and pre-build a workspace command
    ...
    def _matlab_green(self,
        ...
        # Delegate to MATLAB Engine for bit-identical Green output.
    ...
    def _intbessel_batch(self,
        ...
        # Match MATLAB intbessel.m FP ordering exactly.
        ...
        # GPU acceleration: the outer (M, n) = O(M * n_flat) elementwise
    ...
    def _inthankel_batch(self,
        ...
        # Match MATLAB inthankel.m FP ordering exactly.
        ...
        # GPU acceleration — same pattern as _intbessel_batch.  Hankel1
    ...
    def _integrate_semiellipse(self,
        ...
        # Dispatch to ODE backend (MATLAB ode45 mirror) when use_ode
    ...
    def _integrate_semiellipse_ode(self,
            ...
            n1: int,
            n_names: int) -> np.ndarray:
        # solve_ivp RK45 mirroring MATLAB ode45.
        ...
        # When use_matlab_ode45 is set, use complex-y matlab_ode45
    ...
    def _integrate_real_ode(self,
            ...
            n: int,
            n_names: int) -> np.ndarray:
        # solve_ivp RK45 mirroring MATLAB ode45 along real kr-axis.
    ...
    def _integrate_imag_ode(self,
            ...
            n: int,
            n_names: int) -> np.ndarray:
        # solve_ivp RK45 mirroring MATLAB ode45 along imag kr-axis.

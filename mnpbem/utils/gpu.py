...
def solve_dispatch(A: np.ndarray, b: np.ndarray, **kwargs: Any) -> np.ndarray:
    ...
    When ``MNPBEM_VRAM_SHARE_GPUS>=2`` is set, the system is
...
def eigh_dispatch(A: np.ndarray,
    ...
    #
    # Three fixes make the binding production-ready:
...
# ---------------------------------------------------------------------------
#
# cusolverMgSyevd IS in the public cusolverMg.h header (unlike
...
# ---------------------------------------------------------------------------
# Layer-Green / Sommerfeld integral GPU helpers
#

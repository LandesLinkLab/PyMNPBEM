...
# Override with MNPBEM_MATLAB_LIB when MATLAB lives elsewhere; without a
# readable library every wrapper silently falls back to its numpy equivalent.
_MATLAB_LIB_PATH = os.environ.get(
    'MNPBEM_MATLAB_LIB',
    '/usr/local/MATLAB/R2025b/bin/glnxa64/libmwmathutil.so')
_mathutil = None

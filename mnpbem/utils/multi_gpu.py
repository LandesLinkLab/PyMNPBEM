...
"""Multi-GPU wavelength-batched BEM dispatch.
...
def _resolve_bem_class(bem_class_name: Optional[str]) -> Any:
    # Workers run in spawn-ed processes so we cannot pickle a
...
def solve_spectrum_multi_gpu(
    ...
    bem_class : class or str, optional
        ...
        Defaults to ``BEMRet``.  Previously hard-coded so
    ...
    # Accept either a class object or its bare name.  We pass

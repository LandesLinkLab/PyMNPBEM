...
class CompGreenRet(object):
    ...
    def _initclosed(self, g, p1, p2, **options):
        ...
        When ``p1.closed`` is all-None (typical Python user
    ...
    def _matmul(self, a, x):
        ...
        """
        # Accept cupy ndarrays.  Promote host-only sentinels so the
    ...
    def _cross(self, G, h):
        ...
        """
        # Host-promote cupy operands before the ndarray check.
        from ..utils.gpu import to_host as _to_host
